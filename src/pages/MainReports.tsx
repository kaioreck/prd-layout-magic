...
const MainReports: React.FC = () => {
  return (
    <div className="p-3 sm:p-4 md:p-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-3 sm:p-4 md:p-8 mb-3 md:mb-6">
        <h2 className="text-base md:text-xl font-semibold mb-2 md:mb-4">Desempenho de Vendas</h2>
        <div className="h-36 md:h-64 flex items-center justify-center border border-dashed border-gray-300 rounded-lg">
