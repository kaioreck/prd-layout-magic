  ...
  return (
    <div className="p-3 sm:p-4 md:p-6">
      ...
      <div className="flex flex-wrap gap-2 mb-4 md:mb-6">
        <div className="bg-orange-50 border border-orange-200 text-orange-800 px-2 sm:px-3 py-1 sm:py-2 rounded-md text-xs sm:text-sm">
          <span>Vendas entre 01/02/2025 e 28/02/2025</span>
        </div>
        
        <div className="bg-white border border-gray-200 px-2 sm:px-3 py-1 sm:py-2 rounded-md text-xs sm:text-sm">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4 md:p-8 mb-4 md:mb-6 text-center">
